<?php
/* ==========================================================================
   HYDROFLASKER — Fuente de Datos de Productos
   Puedes agregar, modificar o eliminar productos editando este array.
   ========================================================================== */
...
$products = [
    [
        ...
        "bestseller" => false,
        "description" => "Diseñado para tus trayectos diarios. Mantiene tus bebidas frías y cabe perfectamente en la mayoría de portavasos de automóviles."
    ],
    [
        "id" => "basecamp-40",
        ...
        "bestseller" => false,
        "description" => "El compañero ideal para acampar. Capacidad masiva con aislamiento TempShield para mantener tus bebidas heladas bajo el sol del mediodía."
    ],
    [
        "id" => "trailblazer-20",
        ...
        "bestseller" => false,
        "description" => "Ligero, resistente y listo para cualquier sendero. Su tamaño de 20 oz es perfecto para caminatas rápidas y entrenamientos exigentes."
    ],
    [
        "id" => "yeti-rambler-20",
        ...
        "bestseller" => true,
        "description" => "Cualquier vaso que vaya contigo en el viaje debe ser lo suficientemente resistente. El Rambler® de 20 oz está hecho de acero inoxidable duradero con aislamiento al vacío de doble pared."
    ],
    [
        "id" => "hf-wide-32",
        ...
        "bestseller" => true,
        "description" => "Nuestra botella de boca ancha de 32 oz es lo suficientemente grande para un día entero en el río o senderos. Hecha con acero inoxidable de grado profesional."
    ],
    [
        ...
        "colors" => ["#e3dfd3", "#f4d9df", "#d2dbd5", "#2a2d34"],
        "moreColors" => 0,
        ...
        "bestseller" => true,
        "description" => "Construido con acero inoxidable reciclado para beber de manera sostenible, nuestro Quencher H2.0 de 40 oz ofrece máxima hidratación con menos recargas. Cuenta con la tapa avanzada FlowState™ de tres posiciones."
    ],
    [
        "id" => "owala-freesip-24",
        ...
        "bestseller" => true,
        "description" => "La botella de agua FreeSip cuenta con un popote patentado incorporado que permite beber de dos maneras diferentes: a sorbos de forma vertical o inclinando para un trago abundante."
    ]
];
